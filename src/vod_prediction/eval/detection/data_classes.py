...
from vod_prediction.eval.common.data_classes import MetricData, EvalBox
from vod_prediction.eval.common.utils import center_distance
from vod_prediction.eval.detection.constants import DETECTION_NAMES, ATTRIBUTE_NAMES, TP_METRICS
