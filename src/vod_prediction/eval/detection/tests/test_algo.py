...
from vod_prediction.eval.common.utils import center_distance
...
from vod_prediction.eval.detection.data_classes import DetectionMetrics, DetectionMetricData, DetectionBox, \
    DetectionMetricDataList
from vod_prediction.eval.detection.utils import detection_name_to_rel_attributes
