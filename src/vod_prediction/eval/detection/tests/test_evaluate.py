...
from vod_prediction.eval.detection.constants import DETECTION_NAMES
from vod_prediction.eval.detection.evaluate import DetectionEval
from vod_prediction.eval.detection.utils import category_to_detection_name, detection_name_to_rel_attributes
