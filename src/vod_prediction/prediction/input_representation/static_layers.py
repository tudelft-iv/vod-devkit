...
from vod_prediction.eval.common.utils import quaternion_yaw
from vod_prediction.map_expansion.map_api import VODMap, locations
from vod_prediction.prediction import PredictHelper
from vod_prediction.prediction.helper import angle_diff, angle_of_rotation
from vod_prediction.prediction.input_representation.combinators import Rasterizer
from vod_prediction.prediction.input_representation.interface import \
    StaticLayerRepresentation
from vod_prediction.prediction.input_representation.utils import (convert_to_pixel_coords,
                                                       get_crops,
                                                       get_rotation_matrix,
                                                       smooth_rotation)
