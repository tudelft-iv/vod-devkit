...
from vod_prediction.prediction.input_representation.static_layers import StaticLayerRasterizer
from vod_prediction.prediction.models.backbone import ResNetBackbone
from vod_prediction.prediction.models.mtp import MTP, MTPLoss
